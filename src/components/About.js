    ...
    return (
        <section className="about" id="about">
            ...
            <div data-aos="fade-up" data-aos-offset="250" className="about-me">
                <p>Hello! My name is Zakaria, I'm a self taught frontend web developer currently based in Philadelphia, Pennsylvania with a background in civil engineering.</p>
